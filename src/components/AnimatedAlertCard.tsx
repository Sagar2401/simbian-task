...
const AnimatedAlertCard = ({ title, initialCount, type, withSimbian = false }: AlertCardProps) => {
  ...
  return (
    <motion.div 
      ...
      whileHover={withSimbian ? { y: -5, boxShadow: '0 10px 25px rgba(0,0,0,0.2)' } : {}}
      className={cn(
        "relative rounded-xl p-4 min-h-[200px] alert-card",
        withSimbian ? "bg-blue-800/40 border border-blue-400/30" : "bg-gray-800/40 border border-gray-700/30"
      )}
    >
      <motion.div 
